...
export class MasterClassVideoServise {
  ...
  async update(
    ...
    const findMasterClass = await MasterclassCategoryEntity.findOneBy({id: body.category_id || null });
      ...
      if (
        ...
        if (formatVideo !== 'Not video') {
         ...
         await MasterclassVideosEntity.update(id, {
           ...
           description_title : body.description_title || findVideo.description_title,
           description_title_ru : body.description_title_ru || findVideo.description_title_ru,
           description_tactic: body.description_tactic || findVideo.description_tactic,
           description_tactic_ru : body.description_tactic_ru || findVideo.description_tactic_ru,
           tactic_img : img_link,
           video_link ,
